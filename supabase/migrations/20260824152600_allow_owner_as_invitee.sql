-- Allow the booking owner to be invited as an attendee (self-invite).
-- Removes the "The booking owner cannot be invited." raise from create_booking_with_participants.
