...
export function InitialAttendeePicker({
  ...
  return <section className="grid gap-3 border-b-2 border-border pb-7 text-sm">
    <div><p className="text-xs font-semibold uppercase tracking-wide text-violet-700 dark:text-violet-300">Attendees</p><h2 className="mt-1 text-lg font-bold tracking-normal">Invite attendees</h2><p className="mt-1 text-muted-foreground">Optional. Invite active Qbook staff now, or add them later from the booking.</p></div>
